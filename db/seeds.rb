...
Review.create(phrase: "Nightmarish horror", movie_id:Movie.last.id, critic_id:Critic.first.id)
Review.create(phrase: "Compelling biography", movie_id:Movie.first.id, critic_id:Critic.last.id)
